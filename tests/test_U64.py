...
def test_from_bin():
    assert U64.from_bin("1001000110100010101100111100010010000101010111100110111101111") == U64(1311768467294899695)
...
def test_sub():
    assert U64(2**64-1) - U64(1) == U64(2**64-2)
    assert U64(2**64-1) - 1 == U64(2**64-2)
    assert U64(2**64-1) - U64(2**64-1) == U64(0)
    assert U64(2) - U64(2**64-1) == U64(3)
